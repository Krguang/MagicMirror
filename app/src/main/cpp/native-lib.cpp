...
Java_com_yy_k_magicmirror_Serial_Open(JNIEnv *env, jobject instance, jint Port, jint Rate) {
...
JNIEXPORT jint JNICALL
Java_com_yy_k_magicmirror_Serial_Close(JNIEnv *env, jobject instance) {
...
Java_com_yy_k_magicmirror_Serial_Read(JNIEnv *env, jobject instance) {
...
JNIEXPORT jint JNICALL
Java_com_yy_k_magicmirror_Serial_Write(JNIEnv *env, jobject instance, jintArray buffer_, jint buflen) {
    jsize len = buflen;
